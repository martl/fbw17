...
// const ageInfo = classMates.reduce((summary, student, i) => {
//   const sum = summary.sum + student.age;
...
// const studentBeginWithM = classMates.reduce((filteredArr, student) => {
//   if (student.firstName[0].toUpperCase() === 'M') filteredArr.push(student);
//   return filteredArr;
// }, []);
// console.log(studentBeginWithM)

// const studentBeginWithM = []; 
// classMates.forEach(student => {
//   if (student.firstName[0].toUpperCase() === 'M') studentBeginWithM.push(student);
// });
// console.log(studentBeginWithM)

// const studentBeginWithM = classMates.filter(student => student.firstName[0].toUpperCase() === 'M');
// console.log(studentBeginWithM)
