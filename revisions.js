...
// Exercise: Reduce the classMates array to a boolean that indicates
// whether there is an object with the firstName Mojgan is in it.
const theName = classMates.reduce((hasMojgan, studentnames) => {
  if (studentnames.firstName === "Mojgan") {
    return studentnames;
  }
